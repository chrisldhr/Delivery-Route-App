...
def update_truck_packages(start_time,truck_converted_times):
    statuses = []
...
update_truck_packages(convert_to_time(first_truck_start), first_truck_converted_times)
...
update_truck_packages(convert_to_time(second_truck_start), second_truck_converted_times)
...
update_truck_packages(convert_to_time(third_truck_start), third_truck_converted_times)
